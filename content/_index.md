...
<div style="text-align:center; padding: 3rem 1rem 2rem;">
  <h1 style="font-size:2rem; font-weight:700; margin-bottom:0.5rem;">정보시스템 기술사 지식베이스</h1>
  <p style="color:#6b7280; font-size:1.1rem; margin-bottom:2rem;">
    소프트웨어공학·네트워크·보안·알고리즘 등 8개 영역 200+ 토픽을<br>
    다이어그램·표·핵심 키워드로 정리한 무료 학습 자료입니다.
  </p>
...
| 영역 | 주요 토픽 |
|---|---|
| [소프트웨어공학](docs/01-software-engineering) | SDLC, 애자일, 아키텍처 패턴, 테스트, 품질 |
| [데이터베이스](docs/02-database) | 정규화, 트랜잭션, NoSQL, 빅데이터 |
| [네트워크](docs/03-network) | TCP/IP, 라우팅, 무선통신, 5G |
| [보안](docs/04-security) | 암호화, 인증, 침해대응, 보안관리 |
| [컴퓨터구조](docs/05-computer-architecture) | 운영체제, 메모리, 프로세스, 병행처리 |
| [IT관리](docs/06-it-management) | 전략, 거버넌스, 프로젝트, 컴플라이언스 |
| [신기술](docs/07-emerging-tech) | AI/LLM, 클라우드, 블록체인, 메타버스 |
| [알고리즘](docs/08-algorithms) | 자료구조, 정렬, 그래프, P-NP |

---

## 💛 이 자료가 도움이 되셨나요?

이 지식베이스는 기술사 수험생 여러분을 위해 **완전 무료**로 제공됩니다.  
...
<div style="text-align:center; padding: 1.5rem; background: linear-gradient(135deg, #fff9c4 0%, #fffde7 100%); border-radius: 12px; border: 1px solid #f9a825; margin: 1rem 0;">
  <p style="font-size:1.05rem; color:#4a4a4a; margin-bottom:1rem;">
    ☕ 커피 한 잔 값의 후원이 더 많은 토픽 추가와<br>콘텐츠 품질 향상에 큰 힘이 됩니다.
  </p>
