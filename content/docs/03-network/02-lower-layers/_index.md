...
| 번호 | 토픽명 | 계층 | 핵심 키워드 |
|---|---|---|---|
| 1 | L1/L2 MAC 및 에러·흐름 제어 | L1, L2 | CSMA/CD, CSMA/CA, ARQ, 슬라이딩 윈도우 |
| 2 | L2 스위치·VLAN·STP | L2 | MAC 학습, 802.1Q 트렁킹, Spanning Tree |
| 3 | L3 IP 주소 체계 (IPv4/IPv6/NAT) | L3 | CIDR, 서브네팅, IPv6 전환, NAT/PAT |
| 4 | L3 라우팅 프로토콜 | L3 | RIP, OSPF, BGP, ARP, ICMP, IGMP |
