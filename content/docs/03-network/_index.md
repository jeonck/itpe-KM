...
flowchart LR
    A["①<br/>네트워크<br/>구조·OSI"] --"물리·논리<br/>계층을 구성하라"--> B["②<br/>하위 계층<br/>L1~L3"]
    B --"애플리케이션까지<br/>연결하라"--> C["③<br/>상위 계층<br/>L4~L7"]
    C --"네트워크를<br/>소프트웨어화하라"--> Z[" "]
    D["④<br/>SDN·NFV<br/>소프트웨어화"] --"무선·모바일로<br/>확장하라"--> E["⑤<br/>무선·이동<br/>통신"]
    E --"트래픽을<br/>최적 관리하라"--> F["⑥<br/>트래픽 관리<br/>차세대"]
