...
flowchart LR
    A["①<br/>IT 전략<br/>디지털 전환"] --"전략 수립<br/>방향 설정"--> B["②<br/>IT 거버넌스<br/>자산 관리"]
    B --"통제·성과<br/>측정"--> C["③<br/>소싱<br/>서비스 전략"]
    C --"외부 자원<br/>최적화"--> D["④<br/>비즈니스<br/>연속성·위험"]
    D --"리스크<br/>대응"--> E["⑤<br/>최신 패러다임<br/>규제 컴플라이언스"]
